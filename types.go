...
const (
	...
	IMAGE_ASPECT_PLANE_0_BIT  ImageAspectFlags = 0x00000010 // VK_IMAGE_ASPECT_PLANE_0_BIT
	IMAGE_ASPECT_PLANE_1_BIT  ImageAspectFlags = 0x00000020 // VK_IMAGE_ASPECT_PLANE_1_BIT
	IMAGE_ASPECT_PLANE_2_BIT  ImageAspectFlags = 0x00000040 // VK_IMAGE_ASPECT_PLANE_2_BIT
)
...
const (
	...
	FORMAT_R8_UNORM            Format = C.VK_FORMAT_R8_UNORM            // Single channel (for SDF)
